...
## Using a Custom Domain (example.com)
...
Set Cloudflare's SSL/TLS encryption mode to "Full (Strict)" for added security. It tells cloudflare to always choose a secure connection event when talking to your server, this should be the default.
